...
class ScaffoldConfig
{
    ...
    public function __construct(?string $projectRoot = null)
    {
        ...
        $this->templatesPath = $this->projectRoot  .  DIRECTORY_SEPARATOR . 'Scaffold' . DIRECTORY_SEPARATOR . 'templates';
        $this->documentsPath = $this->projectRoot  .  DIRECTORY_SEPARATOR . 'Scaffold' . DIRECTORY_SEPARATOR . 'documents';
    }
